...
export function Departure() {
    ...
    const [currentCoords, setCurrentCoords] = React.useState<LocationObjectCoords | null>(null);
    ...
    const handleDepartureRegister = () => {
        try {
            ...
            if (!licensePlateValidate(licensePlate)) {
                ...
                return Alert.alert("Placa inválida", "A placa inserida é inválida, por favor informe a placa correta.");
            } else {
                setIsValid(true);
    ...
    if (!locationForegroundPermission?.granted) {
        return (
            <Container>
                <Header title="Saída" />
                <Message>
                    Você precisa permitir que o aplicativo tenha acesso a localização para acessar essa funcionalidade. Por favor, acesse as configurações do seu
        ...
        <Container>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={keyboardAvoidingViewBehavior}>
                <ScrollView>
                    ...
                    <Content>
                        {currentAddress && <LocationInfo icon={CarSimple} label="Localização atual" description={currentAddress} />}
                        <LicensePlateInput
                            ref={licensePlateRef}
